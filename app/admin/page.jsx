    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-center transition-transform transform hover:scale-105 hover:shadow-xl"
          >
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-700 transition duration-300"
            >
              {card.buttonText}
            </button>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Owner Approval Status</h2>
        <div className="h-96">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-center hover:shadow-xl transition-shadow">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Total Owners</h3>
          <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">{totalOwners}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-center hover:shadow-xl transition-shadow">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Approved Owners</h3>
          <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
            {ownersData.find((d) => d.name === "Approved")?.count || 0}
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-center hover:shadow-xl transition-shadow">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Not Approved Owners</h3>
          <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
